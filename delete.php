...
<body>
  ...
  <br>
  <h2 class="text-center" style="font-size:25px; font-weight:bold;">DELETE STUDENT DETAILS </h2>
	...
	<table class="table table-hover table-responsive-lg " style="">
      ...
      while($DataRows=mysqli_fetch_array($execute))
      {
       ...
       $Sno++;
		...
		<td><a href="delete_record.php?Delete=<?php echo $Id;?>" style="text-decoration: none;">DELETE</a></td>
        </tr>
        <?php  } ?>
	</table>
